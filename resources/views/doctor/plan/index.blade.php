        ...
        <div class="py-4 bg-white dark:bg-gray-900 flex justify-start">
            <div class="flex flex-col items-center">
                ...
                <span class="text-sm text-gray-700 dark:text-gray-400">
                    Showing <span class="font-semibold text-gray-900 dark:text-white">{{ $plans->firstItem() }}</span>
                    to <span class="font-semibold text-gray-900 dark:text-white">{{ $plans->lastItem() }}</span> of
                    <span class="font-semibold text-gray-900 dark:text-white">{{ $plans->total() }}</span> Entries
                </span>
            </div>
        </div>
