...
@section('container')
    ...
    <div class="container">
        <div class="container-box">
            <!-- Inpatient Care -->
            <div class="facility">
                <img src="{{ asset('images/facility-1.jpg') }}" alt="Inpatient Room">
                <div class="content">
            ...
            <!-- Emergency Unit (ER) -->
            <div class="facility">
                <img src="{{ asset('images/facility-2.jpg') }}" alt="Emergency Unit">
                <div class="content">
             ...
             <!-- Pharmacy -->
             <div class="facility">
                <img src="{{ asset('images/facility-3.jpeg') }}" alt="Pharmacy">
                <div class="content">
                    <h2>Pharmacy</h2>
            ...
            <!-- Cafeteria -->
            <div class="facility">
                <img src="{{ asset('images/facility-4.jpeg') }}" alt="Cafeteria">
                <div class="content">
                    <h2>Cafeteria</h2>
    ...
    <div class="container">
        <div class="container-box">
            ...
            <div class="facility">
                <img src="{{ asset('images/facility-5.jpg') }}" alt="Maternity and Obstetrics Ward">
                <div class="content">
            ...
            <div class="facility">
                <img src="{{ asset('images/facility-6.jpg') }}" alt="Medical and Diagnostic Examination">
                <div class="content">
            ...
            <div class="facility">
                <img src="{{ asset('images/facility-7.jpeg') }}" alt="Consultation and Psychological Services Facility">
                <div class="content">
            ...
            <!-- Surgical Unit -->
            <div class="facility">
                <img src="{{ asset('images/facility-8.jpg') }}" alt="Surgical Unit">
            ...
            <!-- Rehabilitation -->
            <div class="facility">
                <img src="{{ asset('images/facility-9.jpeg') }}" alt="Rehabilitation">
                <div class="content">
             ...
             <!-- Nutrition Center -->
            <div class="facility">
                <img src="{{ asset('images/facility-10.jpeg') }}" alt="Nutrition Center">
                <div class="content">
            ...
            <div class="facility">
                <img src="{{ asset('images/facility-11.jpeg') }}" alt="Research and Education Center">
                <div class="content">
